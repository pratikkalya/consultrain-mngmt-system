                  ...
                  <div class = "col-sm-12">
                      ...
                      <div class ="row">
                       ...
                       <div class ="row">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="date" class="form-control" id="payment_1"  name="payment_1">
                          </div>
                      </div>
                      ...
                      <div class ="row">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="date" class="form-control" id="payment_2"  name="payment_2">
                          </div>
                      </div>
                        ...
                        <div class ="row">
                          <div class= "col-sm-4">
                             ...
                             <input type="date" class="form-control" id="visit3_dt" name="visit3_dt">
                         </div>

                         <div class= "col-sm-4">
                              <label for="payment_3">Payment</label>
                              <input type="date" class="form-control" id="payment_3"  name="payment_3">
                          </div>
                      </div>
                      <div class ="row">
                          <div class= "col-sm-4">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="date" class="form-control" id="payment_4"  name="payment_4">
                          </div>
                      </div>
                  </div>
              </div>
