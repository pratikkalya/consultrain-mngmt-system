                  ...
                  <div class = "col-sm-12">
                      <div class ="row">
                          <div class= "col-sm-4">
                              ...
                              <input type="text" class="form-control" id="purchase_ordr" name="purchase_ordr" value="{{$amc->purchase_ordr}}">
                           </div>
                           ...
                           <div class= "col-sm-4">
                            ...
                            <div class= "col-sm-4">
                              ...
                              <input type="text" class="form-control" id="period" name="period" value="{{$amc->period}}">
                           </div>
                      </div>
                      ...
                      <div class ="row">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="date" class="form-control" id="start_actl_dt"  name="start_actl_dt" value="{{$amc->start_actl_dt}}">
                          </div>
                      </div>
                       ...
                       <div class ="row">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="text" class="form-control" id="payment_1"  name="payment_1" value="{{$amc->payment_1}}">
                          </div>
                      </div>
                      ...
                      <div class ="row">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="text" class="form-control" id="payment_2"  name="payment_2" value="{{$amc->payment_2}}">
                          </div>
                      </div>
                        ...
                        <div class ="row">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="text" class="form-control" id="payment_3"  name="payment_3" value="{{$amc->payment_3}}">
                          </div>
                      </div>
                      <div class ="row">
                          <div class= "col-sm-4">
                         ...
                         <div class= "col-sm-4">
                              ...
                              <input type="text" class="form-control" id="payment_4"  name="payment_4" value="{{$amc->payment_4}}">
                          </div>
                      </div>
                  </div>
              </div>
